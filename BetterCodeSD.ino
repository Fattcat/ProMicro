...
void setup() {
// PIN CS JE na Pri Micro Pine cislo 10 !! ------------------------------------------------------------------------------------------
  if (!SD.begin(10)) {            // TU !! ------------------------------------------------------------------------------------------
// PIN CS JE na Pri Micro Pine cislo 10 !! ------------------------------------------------------------------------------------------
    return;
  }
...
void Press(String b)
{
  ...
  {
    // Ak sa jedná o iné písmeno alebo znak, zistíme jeho hexadecimálny kód a stlačíme príslušnú klávesu
    char c = b[0];
...
uint8_t OemKeyToKeyCode(char c) {
  switch (c) {
    ...
    default: return 0; // Vrátiť 0, ak sa kľúč nenájde
  }
}
